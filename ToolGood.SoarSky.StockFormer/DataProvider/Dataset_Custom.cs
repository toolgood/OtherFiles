...
{
    public class Dataset_Custom : Dataset
    {
        ...
        public virtual void @__read_data__()
        {
            ...
            using (var csv = new CsvReader(reader, CultureInfo.InvariantCulture)) {
                ...
                var num_train = Convert.ToInt32(records.Count() * 0.7);
                var num_test = Convert.ToInt32(records.Count() * 0.2);
                var num_vali = records.Count() - num_train - num_test;

                var border1s = new List<int> { 0, num_train - this.seq_len, records.Count() - num_test - this.seq_len };
                var border2s = new List<int> { num_train, num_train + num_vali, records.Count() };
        ...
        public override Dictionary<string, Tensor> GetTensor(long index)
        {
            ...
            var seq_y = this.data_y[TensorIndex.Slice(r_begin, r_end, null)];
