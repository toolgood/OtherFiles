...
{
    public class NsAutoformerConfig : IConfig
    {
        /// <summary>
        /// 移动平均窗口大小
        /// </summary>
        ...
        public string model { get; set; } = "NsAutoformer";
        ...
        /// </summary>
        public bool distil { get; set; } = false;
        ...
        public string GetSetting(int ii)
        {
            return $"{model}_ft{features}_sl{seq_len}_ll{label_len}_pl{pred_len}_dm{d_model}_nh{n_heads}_el{e_layers}_dl{d_layers}_df{d_ff}_fc{factor}_eb{embed}_dt{distil}_{ii}";
        }
    }
